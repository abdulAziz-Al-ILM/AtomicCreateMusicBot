...
# --- 🧠 HUMANIZER LOGIC (Notalarni tabiiy qilib chalib berish) ---
...
class AudioEngine:
    ...
    def generate_track(self, original_audio, instrument_name):
        ...
        avg_loudness = max(original_audio.rms or 1, 0.1)  # Prevent division by zero
        ...
        for i, chunk in enumerate(chunks):
            ...
            index = min(max(index, 0), steps - 1)  # Ensure index is within bounds
